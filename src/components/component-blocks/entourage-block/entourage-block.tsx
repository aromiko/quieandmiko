    ...
    >
      ...
      <ScrollReveal variant="fade-up" delay={0.2} amount={0} className="w-full">
        <div
          ...
          className="bg-matcha relative my-16 flex w-full flex-wrap overflow-hidden bg-contain px-8 py-20 lg:px-20"
        >
          {entourageBlockBackgroundOverlay && (
            <div
          ...
          {entourageBlockGroupsCollection?.items &&
            ...
            entourageBlockGroupsCollection?.items.map(
              (entourageGroup, index) => (
                <EntourageGroup
