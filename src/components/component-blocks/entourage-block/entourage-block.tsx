...
const EntourageBlock = ({
  ...
  return (
    <section className="container relative mx-auto flex flex-col items-center justify-center px-8 py-16 lg:px-32">
      {entourageBlockTitle && <h2 className="z-20">{entourageBlockTitle}</h2>}
      ...
      >
        <div
          className="h-300 bg-size-[auto_1000px] absolute left-0 z-0 w-full bg-center bg-no-repeat opacity-10"
          style={{
