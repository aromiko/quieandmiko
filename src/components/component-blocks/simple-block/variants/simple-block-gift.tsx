        ...
        <div className="flex flex-wrap items-stretch justify-center gap-6 lg:gap-20">
          {paymentMethods.map((method, index) => (
            <ScrollReveal
              ...
              delay={index * 0.15}
            >
              <div className="border-wine/20 hover:border-wine/40 group relative flex flex-col items-center rounded-xl border bg-white p-6 shadow-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                {/* Label Badge */}
